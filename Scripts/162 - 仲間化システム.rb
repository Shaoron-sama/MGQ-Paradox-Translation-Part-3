...
class << BattleManager
  ...
  def process_follow_enemy515
    ...
    if process_follow_choice
      pic_easy_appear(19)
      pic_easy_appear(18)
      Word.new("他のくのいちエルフ達も起き上がった！", "", 0).execute
      wait_for_message
      process_follow_ok("くのいちエルフ達")
    else
      process_follow_no
      pic_easy_erase(20)
      pic_easy_erase(19)
  ...
  def process_follow_enemy753
    ...
    if process_follow_choice
      pic_easy_appear(19)
      Word.new("ベック・ザ・ビーストも起き上がった！", "", 0).execute
      wait_for_message
      process_follow_ok("ハーゲンベック")
    else
      process_follow_no
      pic_easy_erase(20)
      pic_easy_erase(19)
  ...
  def process_follow_enemy755
    ...
    if process_follow_choice
      pic_easy_appear(19)
      Word.new("セントメイデンも起き上がった！", "", 0).execute
      wait_for_message
      process_follow_ok("サンタマリア")
    else
      process_follow_no
      pic_easy_erase(20)
      pic_easy_erase(19)
  ...
  def process_follow_enemy835
    ...
    if process_follow_choice
      pic_easy_appear(19)
      pic_easy_appear(18)
      Word.new("他のカースエンジェルズ達も起き上がった！", "", 0).execute
      wait_for_message
      process_follow_ok("カースエンジェルズ")
    else
      process_follow_no
      pic_easy_erase(20)
      pic_easy_erase(19)
